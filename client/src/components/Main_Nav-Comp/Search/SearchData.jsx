    ...
    <div className="search-results-inner">
      ...
      <ul>
        ...
        {popularSuggestions.map((suggestion, index) => {
          return (
            <li className="search-suggestions" key={index}>
        ...
        {categories.map((category, index) => {
          return (
            <li className="search-categories bolded" key={index}>
              {category.page_name}
            </li>
          );
        })}
        ...
        {pages.map((page, index) => {
          return (
            <li className="search-pages" key={index}>
              #{page.page_name}
            </li>
          );
        })}
        ...
        {products.map((product, index) => {
          return (
            <li className="search-products" key={index}>
              ...
              <span className="search-products-info">
                ...
                <span className="search-products-price">
                  ${product.price}.00
                </span>
              </span>
            </li>
